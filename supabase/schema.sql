...
CREATE TABLE IF NOT EXISTS public.app_settings (
  ...
  pwa_name TEXT DEFAULT 'SuperPlay App',
  pwa_short_name TEXT DEFAULT 'SuperPlay',
  pwa_theme_color TEXT DEFAULT '#01875f',
  pwa_background_color TEXT DEFAULT '#ffffff',
  icon_192_url TEXT DEFAULT '/icon-192.png',
  icon_512_url TEXT DEFAULT '/icon-512.png',
  apple_touch_icon_url TEXT DEFAULT '/apple-touch-icon.png',
...
CREATE TABLE IF NOT EXISTS public.install_settings (
  ...
  initializing_text TEXT DEFAULT 'Initializing...',
  downloading_text TEXT DEFAULT 'Downloading...',
  installing_text TEXT DEFAULT 'Installing...',
  open_text TEXT DEFAULT 'Open',
